...
#pragma region ShaderProgram
	Shader vertexShader("../shader/depth_test_shader.vert", GL_VERTEX_SHADER);
	Shader fragShader("../shader/depth_test_shader.frag", GL_FRAGMENT_SHADER);
