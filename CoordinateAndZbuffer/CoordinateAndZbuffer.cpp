...
#pragma region IDManaged
	...
	Shader vertexShader("../shader/transform_shader.vert", GL_VERTEX_SHADER);


	//FragmentShader
	//unsigned int fragShader_ID[2];
	//int fragShader_ID_NUM = 1;
	Shader fragShader1("../shader/transform_shader.frag", GL_FRAGMENT_SHADER);
...
#pragma region ExplainVertex
	...
	glVertexAttribPointer(colorInShader, inShaderDataSize, GL_FLOAT, needNormalize, 8 * sizeof(GL_FLOAT), BUFFER_OFFSET(3 * sizeof(GL_FLOAT)));
