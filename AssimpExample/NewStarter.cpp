...
{
#pragma region AssimpTest
	Assimp::Importer importer;
	const aiScene* scene = importer.ReadFile("C://Users//a7183//Desktop//book//test//PBRT//pbrt-v3-scenes//bunny-fur//geometry//bunny.ply",
	...
	auto tmp = scene->mMeshes[0];
	const int numm = tmp->mNumVertices;
	std::vector<float> Vertices;
	for (unsigned int i = 0; i < tmp->mNumVertices; i++) {
		auto pPos = &(tmp->mVertices[i]);
