...
#pragma endregion
    ...
    //shader
    Shader vertexShader("../shader/cubemap_vertex_shader.vert", GL_VERTEX_SHADER);
    Shader fragShader("../shader/cubemap_frag_shader.frag", GL_FRAGMENT_SHADER);

    Shader vertexBoxShader("../shader/cubemap_box_vertex_shader2.vert",GL_VERTEX_SHADER);
