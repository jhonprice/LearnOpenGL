...
#pragma region ShaderProgram
	Shader vertexShader("../shader/blend_test_shader2.vert", GL_VERTEX_SHADER);
	Shader fragShader("../shader/blend_test_shader2.frag", GL_FRAGMENT_SHADER);
...
while (!glfwWindowShouldClose(window)) {
	...
	{
		float distance = glm::length(cameraEnv.camera.Pos - vegetation[i]);
